...
on its own or with meal, our Dry Cider is sure to please. ABV 7%</p>
          <p className="cider-award-silver">-(Great Lakes International Cider and Perry competition) Award
...
patio in the summer or any time of year! ABV 7%</p>
          ...
          <p className="cider-award-bronze">-(Great Lakes International Cider and Perry competition) Award
...
and bourbon with a long finish. Minimally filtered, light carbonation.</p>
          <p className="cider-award-best">-(Great Lakes International Cider and Perry competition) Award
winner- Best in Class 2021</p>
          <p className="cider-award-gold">-(Great Lakes International Cider and Perry competition) Award
