...
function About(){
  ...
  return (
    ...
    <div id="background-1"></div>
    <h3>Why Alma?</h3>
    <p className="about-alma-p">"Alma" is the original word for the apple. In Spanish, "Alma" means soul, and in Latin, it means nurturing spirit. What does Alma mean to us? It means we put our soul and our spirit into knowing and respecting the land, growing the best possible fruit, and making the highest quality Cider.
    </p>
    <div id="background-2"></div>
    <h3>Where is Alma?</h3>
    <p className="about-alma-p">Alma cider is a family operated orchard and cider company in Mount Vernon, WA. Here on the westside of the Cascade mountain range in Washington, we are fortunate enough to live in a microclimate that is extremely well suited for growing cider fruit. Combined with rich native soils formed by our resident volcanoes, glaciers, and rivers we can deliver the gold standard for cider fruit and hope to be able to make world class Cider.
    </p>
    <div id="background-2"></div>
    <h3>What does Alma mean to us?</h3>
    ...
    <h6>We hope you enjoy Alma Cider! As it is truly a labor of love.</h6>
    </div>
  )
}
